...
require_once __DIR__ . '/VisitaManualService.php';

function escape_string_visita(string $str): string
{
    // Legacy facade kept for compatibility with existing controllers.
    return visitaManualEscapeString($str);
}
...
{
    // Legacy facade kept for compatibility with existing callers.
    return visitaManualInsertarVisitaBase(
        $conn,
        $cod_cliente,
        $cod_seccion,
        $cod_vendedor,
...
{
    // Legacy facade kept for compatibility with existing callers.
    return visitaManualRegistrar($data, $forzar);
}

function procesarRegistroVisita(array $data): array
{
    // Legacy facade kept for compatibility with existing controllers.
    return visitaManualProcesarRegistro($data);
