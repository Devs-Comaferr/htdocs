...
if (!function_exists('planificadorViewsDataObtenerDatosZonasClientes')) {
    function planificadorViewsDataObtenerDatosZonasClientes($cod_zona = null): array
    {
        $conn = db();
...
if (!function_exists('planificadorViewsDataObtenerDatosZonasRutas')) {
    function planificadorViewsDataObtenerDatosZonasRutas($cod_zona = null, $cod_ruta_seleccionada = 0): array
    {
        $codigoSesion = obtenerCodVendedorPlanificacionService();
        $zonas = obtenerZonasVisita($codigoSesion);
        $zona_actual = null;
...
if (!function_exists('planificadorViewsDataObtenerDatosCompletarDia')) {
    function planificadorViewsDataObtenerDatosCompletarDia($codigo_vendedor, $fecha): array
    {
