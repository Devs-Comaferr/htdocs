...
csrfValidateRequest('clientes.registrar_whatsapp');

function escape_string_whatsapp(string $str): string
{
...
$observaciones = isset($_POST['observaciones']) ? escape_string_whatsapp((string)$_POST['observaciones']) : null;
